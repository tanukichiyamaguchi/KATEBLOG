...
### 7. 視認性コンポーネント（女性向け・新PASONA連携）
記事は新PASONAの法則（Problem→Affinity→Solution→Offer→Narrowing→Action）で構成される。
各H2に最低1つ、`config/shiji.md` の装飾コンポーネント（①ポイントボックス／②スタッフボイス吹き出し／③チェックリスト／④まとめボックス／⑤マーカー／⑥Q&A）を配置し、
スマホでも「ぱっと見て分かる」レイアウトにする。
- スタッフボイス（②）は Affinity / E-E-A-T として現場エピソードに使う。
- まとめボックス（④）は記事末尾（Action直前）に置く。
- カラーは女性向けのやわらかいパステル（ピンク #fff5f7 / ラベンダー #f7f4ff / ベージュ #fffaf3）で統一。
